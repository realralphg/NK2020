  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-toolbar-title class="text-h6">
          <router-link to="/" tag="span" style="cursor: pointer"> #NK2020 </router-link>
        </q-toolbar-title>
    ...
    <q-footer>
      <div class="text-center bg-grey-10">
        <div class="text-primary">#NK2020</div>        
        <div class="text-grey-6">Copyright 2020</div>        
        <a href="https://www.wedvytes.com" target="_blank">wedvytes.com</a>
